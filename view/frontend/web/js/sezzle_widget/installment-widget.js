    ...
    setInterval(function () {
        ...
        let translation = {
            ...
            'pt': {
                ...
                'month': 'mês',
                'installmentWidget': {
                    14: `4x no PIX ou débito, a cada 15 dias`,
                    30: `4 pagamentos quinzenais, sem juros`
                },
                'modalTitle': 'Como funciona',
                'firstParagraph': {
                    14: `Divida sua compra em 4 pagamentos sem juros e pague a cada 15 dias. Aprovação imediata, sem impacto no seu score de crédito.`,
                    30: `Divida sua compra em 4 pagamentos sem juros e pague a cada 15 dias`
                },
                'secondParagraph': 'Após selecionar "Concluir Pedido" nesse site, você será redirecionado para a Sezzle para concluir sua compra com segurança.',
                'infoIcon': 'Saiba Mais sobre a Sezzle'
            },
        };
		...
		.sezzle-modal-logo {
			background-image: url('https://media.sezzle.com.br/assets/logo+sezzle+180x100px.png') !important;
