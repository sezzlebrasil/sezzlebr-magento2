...
define([
    ...
    return {
        defaults: {
            paymentActionError: $t('Algo deu errado com sua solicitação. Por favor, tente novamente mais tarde.'),
            paymentCancelError: $t('O pagamento foi cancelado.'),
            paymentFailureError: $t('O pagamento falhou. Verifique e tente novamente.'),
            signInMessage: $t('Para fazer o check-out, faça login com seu endereço de e-mail.')
        },
